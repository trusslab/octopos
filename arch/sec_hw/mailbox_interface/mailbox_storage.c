...
int init_storage(void)
{
	...
	Status = XIntc_Connect(&intc,
			XPAR_MICROBLAZE_4_AXI_INTC_OCTOPOS_MAILBOX_4WRI_0_INTERRUPT_FIXED_INTR,
		(XInterruptHandler)handle_mailbox_interrupts,
	...
	Status = XIntc_Connect(&intc, 
			XPAR_MICROBLAZE_4_AXI_INTC_OCTOPOS_MAILBOX_4WRI_0_INTERRUPT_CTRL_FIXED_INTR,
		(XInterruptHandler)handle_change_queue_interrupts, 
	...
	XIntc_Enable(&intc, XPAR_MICROBLAZE_4_AXI_INTC_OCTOPOS_MAILBOX_4WRI_0_INTERRUPT_FIXED_INTR);
	...
	XIntc_Enable(&intc, XPAR_MICROBLAZE_4_AXI_INTC_OCTOPOS_MAILBOX_4WRI_0_INTERRUPT_CTRL_FIXED_INTR);
