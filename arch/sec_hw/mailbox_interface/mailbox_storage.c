...
int init_storage(void)
{
	...
	// 	// printf("%d\r\n", i);
	// 	/* sleep for 1/1000*5 s */
	// 	// for (int j = 0; j < 100000; j++)
	// 	// 	asm ("nop");
	// 	// fop_read(
	// 	// 	(void *) (RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
	// 	// 	sizeof(uint8_t), STORAGE_BLOCK_SIZE, filep);
	// 	fop_read(tmp_data_buf, sizeof(uint8_t), STORAGE_BLOCK_SIZE, filep);
	// 	memcpy((void *) (RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
	// 		tmp_data_buf, STORAGE_BLOCK_SIZE);
	// 	printf("%d 0x%02x%02x%02x%02x\r\n", i, 
	// 		((unsigned char *)(RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[0],
	// 		((unsigned char *)(RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[1],
	// 		((unsigned char *)(RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[2],
	// 		((unsigned char *)(RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[3]);
	// 	// for (int idx = 0; idx < STORAGE_BLOCK_SIZE; idx++) {
	// 	// 	printf("%02x", ((unsigned char *)(RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[idx]);
	// 	// 	if (idx % 16 == 0 && idx > 0)
	// 	// 		printf("\r\n");
	...
	// 	// 	asm ("nop");
	// 	fop_read(tmp_data_buf, sizeof(uint8_t), STORAGE_BLOCK_SIZE, filep);
	// 	memcpy((void *) (RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
	// 		tmp_data_buf, STORAGE_BLOCK_SIZE);
	// 	printf("%d 0x%02x%02x%02x%02x\r\n", i, 
	// 		((unsigned char *)(RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[0],
	// 		((unsigned char *)(RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[1],
	// 		((unsigned char *)(RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[2],
	// 		((unsigned char *)(RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[3]);
	// 	// fop_read(
	// 	// 	(unsigned int *) (RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
	// 	// 	sizeof(uint8_t), STORAGE_BLOCK_SIZE, filep);
	// 	// for (int idx = 0; idx < STORAGE_BLOCK_SIZE; idx++) {
	// 	// 	printf("%02x", ((unsigned char *)(RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE))[idx]);
	// 	// 	if (idx % 16 == 0 && idx > 0)
	// 	// 		printf("\r\n");
	// 	// 	else if (idx % 2 == 0 && idx > 0)
	// 	// 		printf(" ");
	...
	// 		fop_close(filep);
	// 		filep = fop_open("octopos_partition_1_data", "r");
	// 		fop_seek(filep, RAM_UNTRUSTED_PARTITION_BASE + (i+1) * STORAGE_BLOCK_SIZE, SEEK_SET);
	// 	}
	// }
	// fop_close(filep);
	// printf("[1]\r\n");
...
void copy_partitions_to_ram(void)
{
	...
	for (int i = 0; i < fsize / STORAGE_BLOCK_SIZE; i++) {
		...
		// 	(void *) (RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
		// 	sizeof(uint8_t), STORAGE_BLOCK_SIZE, filep);
		// fop_seek(filep, 2048 * STORAGE_BLOCK_SIZE, SEEK_SET);
		fop_read((void *) (RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
			sizeof(uint8_t), STORAGE_BLOCK_SIZE, filep);
		// memcpy((void *) (RAM_ROOT_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
		// 	tmp_data_buf, STORAGE_BLOCK_SIZE);
		/* sleep for 1/1000*5 s */
		...
		// 	// 	asm volatile ("nop");
		// 	filep = fop_open("octopos_partition_0_data", "r");
		// 	fop_seek(filep, (i + 1) * STORAGE_BLOCK_SIZE, SEEK_SET);
		// }
		// break;
	}
	fop_close(filep);
	...
	// 		asm ("nop");
	// 	fop_read((void *) (RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE),
	// 		sizeof(uint8_t), STORAGE_BLOCK_SIZE, filep);
	// 	// memcpy((void *) (RAM_UNTRUSTED_PARTITION_BASE + i * STORAGE_BLOCK_SIZE), 
	// 	// 	tmp_data_buf, STORAGE_BLOCK_SIZE);
	// 	printf("%d 0x%02x%02x%02x%02x\r\n", i, 
