...
int init_storage(void)
{
	...
	Status = XIntc_Connect(&intc,
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_OUT_INTERRUPT_FIXED_INTR,
	...
	Status = XIntc_Connect(&intc,
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_IN_INTERRUPT_FIXED_INTR,
		(XInterruptHandler)handle_mailbox_interrupts,
	...
	Status = XIntc_Connect(&intc,
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_OUT_2_INTERRUPT_FIXED_INTR,
		(XInterruptHandler)handle_mailbox_interrupts,
	...
	Status = XIntc_Connect(&intc,
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_IN_2_INTERRUPT_FIXED_INTR,
		(XInterruptHandler)handle_mailbox_interrupts,
	...
	Status = XIntc_Connect(&intc, 
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_IN_2_INTERRUPT_CTRL_FIXED_INTR,
	...
	Status = XIntc_Connect(&intc, 
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_OUT_2_INTERRUPT_CTRL_FIXED_INTR,
		(XInterruptHandler)handle_change_queue_interrupts, 
	...
	Status = XIntc_Connect(&intc, 
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_IN_INTERRUPT_CTRL_FIXED_INTR,
		(XInterruptHandler)handle_change_queue_interrupts, 
	...
	Status = XIntc_Connect(&intc, 
			XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_OUT_INTERRUPT_CTRL_FIXED_INTR,
		(XInterruptHandler)handle_change_queue_interrupts, 
	...
	/* Enable interrupts */
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_OUT_INTERRUPT_FIXED_INTR);
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_OUT_INTERRUPT_CTRL_FIXED_INTR);
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_IN_INTERRUPT_FIXED_INTR);
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_DATA_IN_INTERRUPT_CTRL_FIXED_INTR);
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_IN_2_INTERRUPT_FIXED_INTR);
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_IN_2_INTERRUPT_CTRL_FIXED_INTR);
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_OUT_2_INTERRUPT_FIXED_INTR);
	XIntc_Enable(&intc, XPAR_STORAGE_SUBSYSTEM_MICROBLAZE_4_AXI_INTC_STORAGE_SUBSYSTEM_Q_STORAGE_OUT_2_INTERRUPT_CTRL_FIXED_INTR);
