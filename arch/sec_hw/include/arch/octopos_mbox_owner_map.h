...
void OMboxIds_init() {
	...
	OMboxIds[Q_STORAGE_IN_2][P_OS] = 0;
	OMboxIds[Q_STORAGE_IN_2][P_RUNTIME1] = 1;
	OMboxIds[Q_STORAGE_IN_2][P_RUNTIME2] = 2;

	OMboxIds[Q_STORAGE_OUT_2][P_OS] = 0;
	OMboxIds[Q_STORAGE_OUT_2][P_RUNTIME1] = 1;
	OMboxIds[Q_STORAGE_OUT_2][P_RUNTIME2] = 2;
	...
	OMboxCtrlIntrs[P_RUNTIME1][Q_STORAGE_OUT_2] = XPAR_MICROBLAZE_2_AXI_INTC_Q_STORAGE_OUT_2_INTERRUPT_CTRL1_INTR;
	OMboxCtrlIntrs[P_RUNTIME1][Q_STORAGE_IN_2] = XPAR_MICROBLAZE_2_AXI_INTC_Q_STORAGE_IN_2_INTERRUPT_CTRL1_INTR;
#elif RUNTIME_ID == 2
	...
	OMboxCtrlIntrs[P_RUNTIME1][Q_STORAGE_DATA_OUT] = XPAR_MICROBLAZE_3_AXI_INTC_Q_STORAGE_DATA_OUT_INTERRUPT_CTRL2_INTR;
	OMboxCtrlIntrs[P_RUNTIME1][Q_STORAGE_DATA_IN] = XPAR_MICROBLAZE_3_AXI_INTC_Q_STORAGE_DATA_IN_INTERRUPT_CTRL2_INTR;
	OMboxCtrlIntrs[P_RUNTIME1][Q_STORAGE_OUT_2] = XPAR_MICROBLAZE_3_AXI_INTC_Q_STORAGE_OUT_2_INTERRUPT_CTRL2_INTR;
	OMboxCtrlIntrs[P_RUNTIME1][Q_STORAGE_IN_2] = XPAR_MICROBLAZE_3_AXI_INTC_Q_STORAGE_IN_2_INTERRUPT_CTRL2_INTR;
	#endif
