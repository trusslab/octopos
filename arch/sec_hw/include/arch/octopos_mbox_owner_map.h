...
void OMboxIds_init() {
	...
	OMboxCtrlIntrs[P_RUNTIME1][Q_STORAGE_CMD_IN] = XPAR_ENCLAVE0_SUBSYS_MICROBLAZE_2_AXI_INTC_ETHERNET_SUBSYSTEM_Q_DATA_IN_INTERRUPT_CTRL1_INTR;
	...
	OMboxCtrlIntrs[P_OS][Q_STORAGE_DATA_OUT] = XPAR_OS_SUBSYS_MICROBLAZE_6_AXI_INTC_ETHERNET_SUBSYSTEM_Q_DATA_OUT_INTERRUPT_CTRL0_INTR;
