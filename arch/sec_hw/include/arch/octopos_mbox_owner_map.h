...
void OMboxIds_init() {
	...
	OMboxCtrlIntrs[P_OS][Q_STORAGE_CMD_IN] = XPAR_XI_INTC_STORAGE_Q_STORAGE_IN_2_INTERRUPT_CTRL0_INTR;
	OMboxCtrlIntrs[P_OS][Q_STORAGE_CMD_OUT] = XPAR_XI_INTC_STORAGE_Q_STORAGE_OUT_2_INTERRUPT_CTRL0_INTR;
	OMboxCtrlIntrs[P_OS][Q_STORAGE_DATA_IN] = XPAR_XI_INTC_STORAGE_Q_STORAGE_DATA_IN_INTERRUPT_CTRL0_INTR;
	OMboxCtrlIntrs[P_OS][Q_STORAGE_DATA_OUT] = XPAR_XI_INTC_STORAGE_Q_STORAGE_DATA_OUT_INTERRUPT_CTRL0_INTR;
	OMboxIntrs[P_OS][Q_KEYBOARD] = 122U;
	OMboxIntrs[P_OS][Q_SERIAL_OUT] = 121U;
	OMboxIntrs[P_OS][Q_RUNTIME1] = 127U;
	OMboxIntrs[P_OS][Q_RUNTIME2] = 137U;
	OMboxIntrs[P_OS][Q_STORAGE_CMD_IN] = XPAR_XI_INTC_STORAGE_Q_STORAGE_IN_2_INTERRUPT_0_INTR;
	OMboxIntrs[P_OS][Q_STORAGE_CMD_OUT] = XPAR_XI_INTC_STORAGE_Q_STORAGE_OUT_2_INTERRUPT_0_INTR;
	OMboxIntrs[P_OS][Q_STORAGE_DATA_IN] = XPAR_XI_INTC_STORAGE_Q_STORAGE_DATA_IN_INTERRUPT_0_INTR;
	OMboxIntrs[P_OS][Q_STORAGE_DATA_OUT] = XPAR_XI_INTC_STORAGE_Q_STORAGE_DATA_OUT_INTERRUPT_0_INTR;
