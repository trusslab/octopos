...
void OMboxIds_init() {
	...
	OMboxCtrlIntrs[P_RUNTIME2][Q_STORAGE_OUT_2] = XPAR_MICROBLAZE_3_AXI_INTC_Q_STORAGE_OUT_2_INTERRUPT_CTRL2_INTR;
	OMboxCtrlIntrs[P_RUNTIME2][Q_STORAGE_IN_2] = XPAR_MICROBLAZE_3_AXI_INTC_Q_STORAGE_IN_2_INTERRUPT_CTRL2_INTR;
	#endif
